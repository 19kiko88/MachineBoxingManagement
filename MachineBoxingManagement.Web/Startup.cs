...
namespace MachineBoxingManagement.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<CAEDB01Context>(options => options.UseNpgsql(Configuration.GetConnectionString("CAEDB01Connection")));
